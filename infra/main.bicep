...
var storageEndpointConfig = {
  ...
  enableTable: true  // Required for Event Hubs trigger checkpointing, Durable Functions and OpenAI triggers and bindings
...
module eventHubsPrivateEndpoint './app/eventhubs-PrivateEndpoint.bicep' = if (vnetEnabled) {
  ...
  params: {
    ...
    tags: tags
    vNetName: vnetName
    eventHubSubnetName: 'eventhub-private-endpoints-subnet'
